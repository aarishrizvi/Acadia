...
export const LandingPage: React.FC<LandingPageProps> = ({
  ...
  return (
    <div className="space-y-16 pb-20">
      {/* Hero Section */}
      <section className="bg-slate-50 border-b border-slate-200 text-slate-900 py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            {/* Left Column: Value Prop */}
            <div className="lg:col-span-7 space-y-6">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-100 border border-slate-200 text-xs font-semibold text-indigo-700">
              ...
              <form onSubmit={handleSearchSubmit} className="max-w-xl">
                <div className="relative flex items-center shadow-lg rounded-lg overflow-hidden">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-28 py-3 bg-white border border-slate-300 text-slate-900 placeholder-slate-400 text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
                  />
                  <button
                    type="submit"
              ...
              <div className="flex flex-wrap items-center gap-3 pt-2">
                ...
                <button
                  ...
                  className="px-5 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-900 border border-slate-300 text-xs sm:text-sm font-semibold rounded-lg transition"
                >
                  Join as Learner
                </button>
              </div>
            ...
            <div className="lg:col-span-5 bg-white/80 border border-slate-200 rounded-xl p-6 sm:p-8 space-y-6 shadow-xl">
              <h3 className="text-xs font-bold uppercase tracking-wider text-slate-500">
                Acadia Platform Standards
              </h3>

              <div className="grid grid-cols-2 gap-4">
                <div className="p-3 bg-slate-50/60 rounded-lg border border-slate-200/60">
                  <p className="text-2xl font-black text-slate-900">{academies.length || 4}</p>
                  <p className="text-[11px] text-slate-500 mt-0.5">Verified Academies</p>
                </div>
                <div className="p-3 bg-slate-50/60 rounded-lg border border-slate-200/60">
                  <p className="text-2xl font-black text-indigo-600">{courses.length || 5}</p>
                  <p className="text-[11px] text-slate-500 mt-0.5">Specialized Courses</p>
                </div>
                <div className="p-3 bg-slate-50/60 rounded-lg border border-slate-200/60">
                  <p className="text-2xl font-black text-emerald-600">1,400+</p>
                  <p className="text-[11px] text-slate-500 mt-0.5">Active Learners</p>
                </div>
                <div className="p-3 bg-slate-50/60 rounded-lg border border-slate-200/60">
                  <p className="text-2xl font-black text-amber-500">4.9 ★</p>
                  <p className="text-[11px] text-slate-500 mt-0.5">Average Rating</p>
                </div>
              </div>
            ...
            >
              ...
              <div className="p-4 pt-0">
                <div className="pt-3 border-t border-slate-100 flex items-center justify-between text-xs">
                  ...
                  <span className="text-[11px] font-semibold px-2 py-0.5 bg-emerald-50 text-emerald-700 border border-emerald-200 rounded">
                    Free Enrollment
                  </span>
                </div>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {featuredAcademies.map((academy) => (
            <div
              ...
              className="cursor-pointer bg-white border border-slate-200 rounded-lg p-5 hover:border-slate-400 hover:shadow-sm transition flex flex-col justify-between"
            >
              <div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white border border-slate-200 rounded-lg p-6 space-y-3">
              <div className="w-8 h-8 rounded-md bg-indigo-50 text-indigo-600 flex items-center justify-center font-bold text-sm">
                1
              </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-indigo-600 text-white border border-indigo-700 rounded-xl p-8 sm:p-12 flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <button
            ...
            className="px-6 py-3 bg-white text-indigo-600 hover:bg-indigo-50 text-xs sm:text-sm font-bold rounded-lg shadow-sm transition whitespace-nowrap"
          >
            Apply as Instructor
          </button>
        </div>
