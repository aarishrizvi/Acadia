        ...
        <div className="p-6 sm:p-8 -mt-12 relative z-10">
          <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between gap-4">
            <div className="flex items-end gap-4">
              <div className="w-20 h-20 rounded-lg bg-white border-2 border-white p-1 shadow-md overflow-hidden shrink-0">
                <img
            ...
            {academy.website && (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="px-3.5 py-1.5 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-md text-xs font-semibold flex items-center gap-1.5 border border-slate-200 transition"
              >
          ...
          <div className="mt-6 pt-5 border-t border-slate-100 grid grid-cols-1 md:grid-cols-3 gap-6 text-xs text-slate-600">
            <div className="md:col-span-2 space-y-1">
              <h3 className="font-bold text-slate-900 uppercase text-[11px] tracking-wider">
                About the Academy
              </h3>
              <p className="text-slate-500 leading-relaxed">{academy.description}</p>
            </div>
            ...
            <div className="bg-slate-50 border border-slate-200 p-4 rounded-lg space-y-2">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <p className="font-semibold text-slate-900">{academy.instructorName}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {academyCourses.map((course) => (
              <div
                ...
                className="group cursor-pointer bg-white border border-slate-200 rounded-lg overflow-hidden hover:border-slate-400 hover:shadow-sm transition flex flex-col justify-between"
              >
                <div>
