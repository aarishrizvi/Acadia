        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-1 space-y-3">
            <div className="flex items-center gap-2">
              ...
              <span className="text-base font-bold tracking-tight text-white">ACADIA</span>
            </div>
            ...
            <div className="flex items-center gap-2.5 pt-1">
              <span className="p-1.5 rounded bg-slate-800 text-slate-400 hover:text-white transition cursor-pointer">
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs">
              <li>
                <button onClick={() => onNavigate('/academies')} className="hover:text-white transition">
                  Hyperion Code Labs
                </button>
              </li>
              <li>
